...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='runs\\train', help='save to project/name')
    ...
    # s = r'--img 416 --batch 40 --epochs 100 --data D:\data\logos_and_signatures\tobacco_yolov5\data.yaml --cfg .\models\custom_yolov5s.yaml --name yolov5s_results  --cache'
